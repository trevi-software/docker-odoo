...
class hr_turnover_wizard(osv.TransientModel):
    ...
    _name = 'hr.manpower.turnover'
    _description = 'Combined Manpower/Turnover Report'
    
    _columns = {
        'start_date': fields.date('Start', required=True),
        'end_date': fields.date('End', required=True),
        'department_ids': fields.many2many('hr.department', 'hr_employee_mpto_wizard_rel', 'department_id',
    ...
    def print_report(self, cr, uid, ids, context=None):
        ...
        return {
            ...
            'report_name': 'hr_manpower_turnover',
            'datas': datas,
        }
