...
class hr_employee(osv.osv):
    ...
    _columns = {
        'contract_id':fields.function(_get_latest_contract, string='Contract', type='many2one', relation="hr.contract",
                                      store={'hr.contract': (_get_id_from_contract,['id','date_start'],10)},
    ...
    _sql_constraints = [
        ('unique_identification_id', 'unique(identification_id)', _('Official Identifications must be unique!')),
    ]
