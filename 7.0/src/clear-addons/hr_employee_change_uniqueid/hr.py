...
class hr_id_change(orm.Model):
    
    _name = 'log.change.employee.uniqueid'
    _description = 'Employee Unique ID Change Log'
    ...
    def create(self, cr, uid, vals, context=None):
        ...
        return super(hr_id_change, self).create(cr, uid, vals, context=context)
