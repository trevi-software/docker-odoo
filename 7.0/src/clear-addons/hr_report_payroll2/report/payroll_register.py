...
class Parser(report_sxw.rml_parse):
    def __init__(self, cr, uid, name, context):
        ...
        self.localcontext.update({
            ...
            'get_holbonus': self.get_holbonus,
            ...
            'get_ded_holbonus': self.get_ded_holbonus,
            ...
            'get_tot_holbonus': self.get_tot_holbonus,
            ...
            'get_tot_ded_holbonus': self.get_tot_ded_holbonus,
    ...
    def get_details_by_payslip(self, payslips):
        ...
        # Re-order pay slips by Legacy ID
        #
        #        payslips2 = []
        #        for slip in payslips:
        #            if len(payslips2) == 0:
        #                payslips2.append(slip)
        #                continue
        #
        #            for slip2 in payslips2:
        #                if slip2.employee_id.legacy_no > slip.employee_id.legacy_no:
        #                    idx = payslips2.index(slip2)
        #                    payslips2 = payslips2[:idx] + [slip] + payslips2[idx:]
        #                    break
        #                else:
        #                    if slip2 == payslips2[-1]:
        #                        payslips2.append(slip)
        #                        break
        #                    else:
        #                        continue
        ...
        for slip in payslips:
            ...
            tmp['seniority'] = slip.employee_id.length_of_service
            # if tmp['gross'] > 0:
            res.append(tmp)
        return res
    ...
    def get_details_by_rule_category(self, obj):
        ...
        if ids:
            ...
            for r in res:
                ...
                if r['code'] == 'CALCBASIC' and r['level'] != 0:
                ...
                elif r['code'] in ('WORKWAGE', 'BASIC', 'UTODOCK') and r['level'] == 0:
                    ...
                    regline['holbonus_allow'] += r['total']
                elif r['code'] == 'ALW':
                    ...
                    regline['holbonus_deduct'] += r['total']
            ...
            regline['allowances'] -= regline['holbonus_allow']
            ...
            regline['deductions'] -= regline['holbonus_deduct']
            ...
            self.holbonus_allow += regline['holbonus_allow']
            ...
            self.ded_holbonus += regline['holbonus_deduct']
            ...
            self.tot_holbonus_allow += regline['holbonus_allow']
            ...
            self.tot_ded_holbonus += regline['holbonus_deduct']
    ...
    def get_holbonus(self, obj):
        return self.holbonus_allow

    def get_tot_holbonus(self, obj):
        return self.tot_holbonus_allow
    ...
    def get_ded_holbonus(self, obj):
        return self.ded_holbonus

    def get_tot_ded_holbonus(self, obj):
        return self.tot_ded_holbonus
