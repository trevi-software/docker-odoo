...

{
	...
	"init_xml" : [],
	"update_xml" : [
        "security/hr_clock_reader_security.xml",
        "security/ir.model.access.csv",
        "wizard/hr_clock_reader_view.xml",
        "wizard/registration_quality_view.xml",
        "hr_clock_reader_view.xml",
        "hr_clock_reader_wizard.xml",
        "hr_clock_reader_cron.xml",
    ],
	"demo_xml" : [],
	"installable": True,
	"active": False,
