...
#    Copyrigth (C) 2014 Michael Telahun Makonnen <mmakonnen@gmail.com>
...
class Parser(report_sxw.rml_parse):
    def __init__(self, cr, uid, name, context):
        ...
        self.localcontext.update({
            ...
            'get_pf_er': self.get_pf_er,
            'get_pension_total': self.get_pension_total,
        })
        self.no = 0
        self.salary = 0.0
        self.workwage = 0.0
    ...
    def get_details_by_payslip(self, payslips):
        ...
        for slip in payslips:
            ...
            if tmp['gross'] > 0.009 and tmp['pension_total'] > 0.009:
                res.append(tmp)
            else:
                self.salary -= tmp['salary']
                self.ded_pf_ee -= tmp['ee_pension']
                self.pf_er -= tmp['er_pension']
                self.pension_total -= tmp['pension_total']
        return res
    ...
    def get_details_by_rule_category(self, obj):
        ...
        if ids:
            ...
            # Total Pension
            #
            regline['pension_total'] = regline['ee_pension'] + regline['er_pension']
            ...
            self.pf_er += regline['er_pension']
            self.pension_total += regline['pension_total']
    ...
    def get_pf_er(self, obj):
        return self.pf_er
    
    def get_pension_total(self, obj):
