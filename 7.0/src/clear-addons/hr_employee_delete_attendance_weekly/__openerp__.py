...
{
    'name': 'Delete Employee Record - Weekly Attendance',
    'summary': 'Permanently delete an employee\'s weekly attendance records',
    'version': '1.0',
    'category': 'Human Resources',
    'description': """
Delete Employee Record - Weekly Attendance
==========================================
